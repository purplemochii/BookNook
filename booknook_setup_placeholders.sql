...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 29, 2025 at 11:43 PM
...
INSERT INTO `books` (`book_id`, `title`, `year`, `genre_id`, `isbn`, `price`, `blurb`) VALUES
(1, 'The Glass Orchard', 2018, 1, '978-0123456781', 12.99, 'A twisty mystery set in a remote glass-making town.'),
(2, 'Stars Beneath the Water', 2021, 2, '978-0123456782', 14.50, 'Deep space adventure with complex moral dilemmas.'),
(3, 'A Map of Quiet Places', 2015, 3, '978-0123456783', 10.99, 'A poignant coming-of-age story in rural Canada.'),
(4, 'The Clockmaker\'s Dilemma', 2009, 4, '978-0123456784', 11.25, 'Gears, steam, and an impossible time machine.'),
(5, 'Honey on the Horizon', 2022, 5, '978-0123456785', 13.99, 'A heartwarming summer romance on the coast.'),
(6, 'Winter\'s Algebra', 2011, 6, '978-0123456786', 15.75, 'A challenging tale of philosophy and mathematics.'),
(7, 'The Ninefold Pact', 2019, 7, '978-0123456787', 16.99, 'Epic high fantasy with dark magic and ancient gods.'),
(8, 'Concrete Roses', 2017, 8, '978-0123456788', 9.99, 'A powerful story of resilience in an urban landscape.'),
(9, 'Shadows on the Fifth Floor', 2013, 9, '978-0123456789', 12.50, 'Gritty, hard-boiled detective fiction.'),
(10, 'Synthetic Dawn', 2024, 10, '978-0123456790', 17.20, 'Future dystopia with artificial intelligence conflict.');
